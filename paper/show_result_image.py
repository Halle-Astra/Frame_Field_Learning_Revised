...
def main_mine():
    val_annotations_filepath = "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/raw/val/annotation.json"
    val_images_dirpath = "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/raw/val/images"
    ...
    info_list = [
        ...
        {
            "output_filename_format": "crowdai_unet16_{:012d}.poly_viz.acm.tol_0.125.pdf",
            "annotations_filepath": "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/eval_runs/mapping_dataset.unet16 | 2021-08-18 08:38:40//test.annotation.poly.acm.tol_0.125.json"
        },
        {
            "output_filename_format": "crowdai_unet16_{:012d}.poly_viz.acm.tol_1.pdf",
            "annotations_filepath": "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/eval_runs/mapping_dataset.unet16 | 2021-08-18 08:38:40//test.annotation.poly.acm.tol_1.json"
        },
        {
            "output_filename_format": "crowdai_unet16_{:012d}.poly_viz.asm.tol_0.125.pdf",
            "annotations_filepath": "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/eval_runs/mapping_dataset.unet16 | 2021-08-18 08:38:40//test.annotation.poly.asm.tol_0.125.json"
        },
        {
            "output_filename_format": "crowdai_unet16_{:012d}.poly_viz.asm.tol_1.pdf",
            "annotations_filepath": "/data/sda/datasets/Datasets4FFL/mapping_challenge_dataset/eval_runs/mapping_dataset.unet16 | 2021-08-18 08:38:40//test.annotation.poly.asm.tol_1.json"
        }
    ]
    #image_id_list = [8001]
    image_id_list = [21219, 443, 371, 265, 18205, 1, 2, 3, 4]  # before bug solved, these id no data in asm results.
    # image_id_list = [443]
