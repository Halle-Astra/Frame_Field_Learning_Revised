...
class MappingChallenge(LydornDataset):
    def __init__(self, root, transform=None, pre_transform=None, fold="train", small=False, pool_size=1):
        ...
        print(f"FILE:{__file__}\n"
              f"\tInfo, Class MappingChallenge is initializing.")
        if fold == "test_images":
        ...
        print(f"FILE:{__file__}\n"
              f"\tInfo, MappingChallenge has been loaded.")# 估计是开了多进程放后台加载数据去了
        ...
        print(f"FILE:{__file__}\n"
              f"\tInfo, Class MappingChallenge finished initializing.")
    ...
    def _download(self):
        print(f"FILE:{__file__}\n"
              f"\tInfo, _downlaod function will be executed but nothing will be done, actually.")
        pass
