...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root=None, transform=None, pre_transform=None,
        ...
        print(f"FILE:{__file__}\n"
              f"\tInfo, Class Dataset is initializing.")
        ...
        print(f"FILE:{__file__}\n"
              f"\tvar inspecting, class keys:{self.__class__.__dict__.keys()}")
        if 'download' in self.__class__.__dict__.keys():
            print(f"FILE:{__file__}\n"
                  f"\tInfo, var download is in keys of class dict.")
            self._download()
        ...
        print(f"FILE:{__file__}\n"
              f"\tInfo, Class Dataset finished initializing.")
    ...
    def _download(self):
        import os
        print(f"FILE:{__file__}\n"
              f"var inspecting,\n\t self.raw_file_names:{self.raw_file_names}")
